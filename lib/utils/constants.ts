...
export const FOUR_D_MODEL = [
  {
    key: 'drive',
    name: 'Drive',
    description: 'Internal motivation, discipline, and ownership. The behavioural foundation of all development. Applied Week 3 — GTB Mentoring: mindset, confidence, resilience, and player ownership.',
    short: 'Motivation, ownership & the mindset to lead your own development.',
    weekLabel: 'W3 — Mentoring',
    color: '#C9A84C',
  },
  {
    key: 'decision',
    name: 'Decision',
    description: 'Awareness, cognition, and adaptability. Linking knowledge to action under pressure. Applied Week 4 — GTB Education Tactical: game IQ, decision-making, reading the game, off-ball intelligence.',
    short: 'Intelligence, awareness & the ability to read any situation.',
    weekLabel: 'W4 — Tactical',
    color: '#5BB8E8',
  },
  {
    key: 'delivery',
    name: 'Delivery',
    description: 'Quality execution and applied performance. Where Drive and Decision become visible. Applied Week 1 — GTB Education Technical: skill, technique, body mechanics, execution under pressure.',
    short: 'Technical execution, precision & consistency under pressure.',
    weekLabel: 'W1 — Technical',
    color: '#2E8B35',
  },
  {
    key: 'durability',
    name: 'Durability',
    description: 'Physical robustness and psychological resilience. The sustainability layer that protects long-term growth. Applied Week 2 — GTB Fitness S&C: physical development and conditioning for footballers.',
